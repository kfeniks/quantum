...
namespace backend\modules\investment\controllers;

use Yii;
use backend\modules\investment\models\Investment;
use backend\modules\investment\models\InvestmentSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for Investment model.
 */
