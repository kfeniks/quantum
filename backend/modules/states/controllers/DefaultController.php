...
namespace backend\modules\states\controllers;

use Yii;
use backend\modules\states\models\States;
use backend\modules\states\models\StatesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for States model.
 */
